        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="card-luxury p-8 border border-border">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full button-primary bg-primary text-primary-foreground hover:shadow-lg flex items-center justify-center gap-2"
              >
                <Send size={18} />
                Send Message
              </button>
          ...
          <div className="space-y-8">
            ...
            <div className="card-luxury p-6 flex gap-4 hover:shadow-lg transition-all border border-border">
              ...
              <div>
                ...
                <p className="text-foreground/70">Vehkateshwar Theatre Road<br />Narayankhed, Sangareddy Dist.</p>
              </div>
            </div>
            ...
            <div className="card-luxury p-6 flex gap-4 hover:shadow-lg transition-all border border-border">
              ...
              <div>
                ...
                <p className="text-foreground/70">Mon - Sat: 08:00 AM - 7:00 PM<br />Sun: 06:00 AM - 08:00 PM</p>
              </div>
            </div>
          </div>
        </div>
